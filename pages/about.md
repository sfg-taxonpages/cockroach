...
---
# About
Building community around and gathering knowledge about the world’s cockroaches.
...
- **Cite** this website: Beccaloni, G. Cockroach Species File. [retrieval date]. <https://cockroach.speciesfile.org>. See also [Terms of use](#terms-of-use).
...
- Core taxonomic data are exported to and available at the [Catalogue of Life](https://www.catalogueoflife.org/data/taxon/TM) and its [associated API](https://api.checklistbank.org/dataset/3LR/taxon/TM).
