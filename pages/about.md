...
- Core taxonomic data are exported to and available at the [Catalogue of Life](https://www.catalogueoflife.org/data/taxon/TM) and its [associated API]({https://link_to_api_for_pertinent_dataset}).
